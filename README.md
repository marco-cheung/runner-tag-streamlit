...
Earlier before, I joined a half-marathon race in Hong Kong and soon realized that it was painful to search and find my photos one-by-one in official photo website (with 21229 photos in total). Therefore, I decided to build on this platform for these race photos. I hope this service not only enhance race experience of runners, but also enable event event organizer to provide a value-added service for runners after the race.
