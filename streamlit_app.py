...
if text_search:
    for n_row, row in subset_df_search.reset_index().iterrows():
        ...
        with cols[n_row%N_cards_per_row]:
            ...
            st.markdown(f'<a href="https://www.facebook.com/sharer/sharer.php?u={row["image_path"]}" target="_blank"><button style="border:none;background:none;"><img src="https://github.com/marco-cheung/runner-tag-streamlit/blob/main/.streamlit/fb-icon.png" width="10" height="10"></button></a>', unsafe_allow_html=True)
